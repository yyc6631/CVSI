# CIRR, CIRCO and FASHIONIQ prompts all follow the CIReVL
# to ensure fair comparison across datasets.
...
###################################
re_and_add_prompt = '''
I have an image. Given an instruction to edit the image, carefully predict the objects that are most likely to be added in the edited image. I will provide the image content beginning with “Image Content:”. The instruction I provide will begin with “Instruction:”. 
For Objects most likely added, provide a noun phrase describing the new objects introduced by the instruction, adding any necessary details based on the modification.
